...
\begin{axis}[
    ...
    legend entries={$i=0.082$,$i=0.101$,$v=33.3 m/s$,$f=0.3Hz$},
    grid = both,
    minor y tick num= 4,
    minor x tick num= 4,
]
\addplot[blue, domain = 0:44.4,samples=201,]{0.082*x};
\addplot[red, domain = 0:44.4,samples=201,]{0.101*x};
...
\addplot[blue, domain = 0:44.4,samples=201,]{0.057*x};
\addplot[red, domain = 0:44.4,samples=201,]{0.07*x};
